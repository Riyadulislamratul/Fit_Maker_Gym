...
/* =========================================================
   ANIMATED PRICE
   Optimized:
   - Does NOT call React setState every animation frame.
   - Updates the DOM directly through a ref.
========================================================= */
  ...
  ({ price, shouldReduceMotion }) => {
    ...
    useEffect(() => {
      ...
      if (shouldReduceMotion) {
        priceRef.current.textContent = target;
        return;
      }
      ...
      const animate = (currentTime) => {
        ...
        priceRef.current.textContent = Math.floor(
          target * easeOut
        );
    ...
    return <span ref={priceRef}>0</span>;
  }
);
...
const PlanCard = memo(
  ({
    ...
    /*
      Cache the card dimensions.

      Previously:
      getBoundingClientRect()
      was called on EVERY mousemove.

      Now:
      It is called once when the mouse enters.
    */
    ...
    return (
      ...
      >
        ...
        >
          ...
          {/* =================================================
              TOP GLOW
              Continuous animation moved to CSS.
          ================================================== */}
...
const PlansSection = () => {
  ...
  return (
    ...
    >
      {/* ==================================================
          RED BACKGROUND GLOW
          Moved to CSS for cheaper continuous animation.
      ================================================== */}
      ...
      >
        ...
        >
          ...
          >
            ...
            Coaches Guide You Every Step Of
            The Way.
          </motion.p>
        </motion.div>
